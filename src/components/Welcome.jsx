    ...
    <div className="welcome">
      <div className="welcome-inner">
        <div className="welcome-text">
          ...
          <p>Browse 800+ functional fitness workouts, track your scores, log PRs, and build custom collections. Sign in to start your journey.</p>
          <div className="welcome-features">
            <div className="wf-item"><span>🏋</span><span>800+ Workouts</span></div>
